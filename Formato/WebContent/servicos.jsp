...
<body>
	...
	<div class="w3-row-padding w3-padding-64 w3-container">
		...
		<h5 class="w3-padding-32">A revisão textual consiste na execução
			de serviços de verificação e acertos que envolve toda estrutura do
			texto do documento. A revisão textual evita perdas da semântica da
			informação, informações incorretas, erros gramaticais e conceituais
			visando a entrega e apresentação do documento final de forma
			aceitável.</h5>
		...
		<div class="w3-container">
			...
			<ul class="w3-ul w3-hoverable">
				<li>Revisão gramatical: consiste na leitura do texto e sua
					adequação aos critérios gramaticais,ortográficos e sintáticos da
					norma culta da língua portuguesa.</li>
				<li>Adequação às normas da ABNT: revisa-se o texto de forma a
					garantir que atenda às normas da Associação Brasileira de Normas
					Técnicas (ABNT).</li>
				<li>Textual-gramatical: inclui tanto a revisão gramatical
					quanto a análise crítica do texto, apontando aspectos de construção
					textual que levem a um texto mais claro.</li>
				<li>Edição/formatação: prepara, de acordo com as normas
					editoriais, um texto ou uma seleção de textos, com ações de
					padronização de fonte, inserção de índice, formatação etc.</li>
			</ul>
		</div>
	...
	<div class="w3-container">
		<h2>Veja as nossas formas de cobrança</h2>
	</div>
	...
	<div class="w3-row-padding">
		...
		<div class="w3-third w3-margin-bottom">
			<ul class="w3-ul w3-border w3-center w3-hover-shadow">
				<li class="w3-red w3-xlarge w3-padding-32">Por página</li>
				<li class="w3-padding-16"><b><input type="checkbox"
						name="vehicle" value="Bike"></b> Revisão gramatical</li>
				<li class="w3-padding-16"><b><input type="checkbox"
						name="vehicle" value="Bike"></b> Adequação ABNT</li>
				<li class="w3-padding-16"><b><input type="checkbox"
						name="vehicle" value="Bike"></b> Textual-gramatical</li>
				<li class="w3-padding-16"><b><input type="checkbox"
						name="vehicle" value="Bike"></b> Edição/Formatação</li>
