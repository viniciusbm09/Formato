			...
			<div class="w3-content">
				<div class="w3-container">
					<form action="mvc?logica=AtualizarCadastro"
						...
						method="post">
						<h2 class="w3-center">Alteração de dados cadastrais</h2>
				...
				<div class="w3-container">
					<form action="upload"
						...
						<div class="w3-row w3-section">
							<h4>Clique no botão 'Procurar' para selecionar o arquivo de
						...
						<p>
							<input class="w3-radio" type="radio" name="porPagina"
								value="pagina" checked> <label>Por página</label>
						</p>
						<p>
						...
						<p>
							<input class="w3-radio" type="radio" name="porLauda"
								...
								equivale a um texto com 1.250 caracteres (incluindo os espaços))</label>
						</p>
